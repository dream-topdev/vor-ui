...
const { REACT_APP_XYDistribution_ADDRESS, REACT_APP_WEB3_PROVIDER_HTTP, REACT_APP_WEB3_PROVIDER_WS } = process.env
...
class XYDistribution {
  async initWeb3() {
    ...
    this.contractWs = await new this.web3Ws.eth.Contract(XYDistributionABI, REACT_APP_XYDistribution_ADDRESS)
  ...
  async searchEventsForRequest(fromBlock, toBlock, eventName, distId) {
    return new Promise((resolve, reject) => {
